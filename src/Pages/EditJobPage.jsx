...
function EditJobPage({updateJobSubmit}) {
  ...
  const [contactPhone,setContatPhone] = useState(job.company.contactPhone);
            ...
            <form onSubmit={submitForm}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  value={companyName}
                  onChange={(cN)=> setCompanyName(cN.target.value)}
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  onChange={(cd)=> setCompanyDescription(cd.target.value)}
                ></textarea>
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  required
                  value={contactEmail}
                  onChange={(ce)=> setContactEmail(ce.target.value)}
                />
              </div>
              <div className="mb-4">
                <label
                ...
                <input
                  ...
                  value={contactPhone}
                  onChange={(cp)=> setContatPhone(cp.target.value)}
                />
              </div>
